...
import com.uci.ta.licenseplatereader.utils.camera.CameraSource;
import com.uci.ta.licenseplatereader.utils.camera.CameraSourcePreview;
...
public abstract class OcrCaptureActivity extends AppCompatActivity {
    ...
    public void setBackButton(){
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setNavigationIcon(R.drawable.ic_arrow_back_white_24px); // your drawable
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(icon!=null) {
            icon.mutate();
            //ColorFilter colorFilter = ColorFilterGenerator.from(icon).to(getResources().getColor(R.color.white));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_flash:
                ...
                if(useFlash){
                    item.setTitle(R.string.action_enable_flash);
                    item.setIcon(R.drawable.ic_flashlight);
                }else{
                    item.setTitle(R.string.action_disable_flash);
    ...
    private void enableFlash(boolean isEnable){
        getIntent().putExtra(UseFlash, isEnable);
        if(mCameraSource!=null){
